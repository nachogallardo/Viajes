...
/**
 * Servlet implementation class EditarUsuAdmin
 */
public class EditarUsuAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditarUsuAdmin() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!uDao.validarUsuario(usu)) {
		    ...
		    response.sendRedirect("jsp/editarPerfilAdmin.jsp?info=Usuario Editado");
		}else {
		  response.sendRedirect("jsp/editarPerfilAdmin.jsp");
		}
	}
