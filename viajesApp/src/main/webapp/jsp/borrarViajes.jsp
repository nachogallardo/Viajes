			...
			<div class="col-lg-3 col-md-3 col-sm-3">
				<article class="card">
					...
					<div class="card-block">
						...
						<a data-toggle="modal" data-target="#borrarViaje<%=v.getIdViaje()%>" class="btn btn-outline-danger btn-block"><i class="fa fa-trash" aria-hidden="true"></i> Borrar Viaje</a>
					</div>
				</article>
			</div>
			
 <div class="modal fade" id="borrarViaje<%=v.getIdViaje()%>"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary"
                                            onclick="location.href='../BorrarViaje?id=<%=v.getIdViaje()%>'">Sí</button>
                                    </div>
                                </div>
                            </div>
                        </div>
